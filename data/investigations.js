...
window.RADAR_PARTS.investigations={
 ...
 "educacao":{
  ...
  stages:[
   ...
   {id:"escolas",label:"Base georreferenciada de escolas",status:"planejado",evidence:["Censo Escolar/Inep foi definido como caminho de dados, mas o histórico recuperado não comprova ainda extração/análise efetiva","Sistemas municipais e estaduais foram localizados para complementar a busca; não comprovam extração, download ou análise"],sources:["edu-censo-escolar","edu-salvador-numeros","edu-sigeduc-ba"]},
