...
window.RADAR_PARTS.investigations={
 ...
 "data-centers":{
  ...
  stages:[
   ...
   {id:"incentivos",label:"Incentivos, dinheiro público e política setorial",status:"em_apuracao",evidence:["Redata e incentivos fiscais integram a investigação; PL 278/2026 acompanhado","SDE e TCE-BA foram catalogados como fontes complementares para identificar programas/atos e dimensionar renúncia fiscal; beneficiários individuais ainda exigem cruzamento documental"],sources:["dc-base-propria","dc-sde-incentivos","dc-tce-renuncia"]},
  ...
  sources:[
   ...
   {id:"dc-delano",dataset:"plot-datacenters-delano",name:"Entrevista com Delano — energia e sistema elétrico",type:"Entrevista técnica",status:"usada",detail:"Fonte técnica para geração renovável, transmissão, grandes cargas e curtailment; orienta documentos a buscar e não prova fatos específicos dos projetos."},{id:"dc-siget",dataset:"aneel-siget",name:"ANEEL — SIGET",type:"Base pública complementar",status:"planejada",detail:"Fonte complementar recém-catalogada para testar infraestrutura de transmissão, subestações, linhas, módulos e pontos de conexão."},{id:"dc-samp",dataset:"aneel-samp",name:"ANEEL — SAMP",type:"Base pública complementar",status:"planejada",detail:"Fonte complementar recém-catalogada para mercado, consumo/demanda e identificação de agentes acessantes; requer teste de granularidade para o recorte da investigação."},{id:"dc-bdgd",dataset:"aneel-bdgd",name:"ANEEL — BDGD",type:"Base pública complementar",status:"planejada",detail:"Base geográfica anual das distribuidoras, incluindo ativos e recursos de unidades consumidoras de pessoas jurídicas; útil para testes espaciais e de infraestrutura, sem presumir vínculo com empreendimentos."},{id:"dc-sde-incentivos",dataset:"bahia-sde-incentivos",name:"SDE Bahia — incentivos fiscais",type:"Fonte pública complementar",status:"planejada",detail:"Programas, procedimentos, planilhas e atos de incentivos; útil para rastrear Desenvolve/ProBahia e resoluções por empreendimento."},{id:"dc-tce-renuncia",dataset:"bahia-tce-renuncia-fiscal",name:"TCE-BA — renúncia fiscal",type:"Fonte pública complementar",status:"planejada",detail:"Relatórios anuais permitem dimensionar renúncia por programa e localizar achados de auditoria; não individualizam necessariamente cada beneficiário."}
  ]
 },
 "futebol":{
  updated:"2026-09-25",
 ...
 "educacao":{
  ...
  stages:[
   ...
   {id:"escolas",label:"Base georreferenciada de escolas",status:"planejado",evidence:["Censo Escolar/Inep foi definido como caminho de dados, mas o histórico recuperado não comprova ainda extração/análise efetiva","Sistemas municipais e estaduais foram localizados para complementar a busca; não comprovam extração, download ou análise","Base dos Dados oferece tabelas tratadas e Catálogo de Escolas; validar ano de referência, acesso e campos antes de usar"],sources:["edu-censo-escolar","edu-salvador-numeros","edu-sigeduc-ba","edu-bd-censo","edu-bd-catalogo"]},
  ...
  sources:[
   {id:"edu-pitch",dataset:"plot-educacao-cep-escola",name:"PLOT. — pauta CEP-escola / submissão Jeduca",type:"Documento editorial",status:"usada",detail:"Define recorte, hipótese e método proposto; não equivale a base de dados já analisada."},{id:"edu-censo-escolar",dataset:"inep-censo-escolar",name:"INEP — Microdados do Censo Escolar",type:"Base pública complementar",status:"planejada",detail:"Fonte prevista para identificar e caracterizar escolas; permanece planejada até haver extração/análise efetiva no projeto."},{id:"edu-salvador-numeros",dataset:"salvador-educacao-numeros",name:"SMED Salvador — Educação em Números",type:"Sistema municipal de indicadores",status:"planejada",detail:"Relatórios por Prefeitura-Bairro/regional foram localizados; filtros, período, possibilidade de exportação e disponibilidade atual ainda precisam ser testados. Não registrar como base extraída."},{id:"edu-sigeduc-ba",dataset:"sigeduc-escolas-ba",name:"SIGEduc Bahia — escolas estaduais",type:"Sistema estadual de consulta",status:"planejada",detail:"Painel e relatório analítico com filtros por ano, NTE, município e escola; fonte complementar da rede estadual, não substitui a análise da rede municipal nem do Censo Escolar."},{id:"edu-bd-censo",dataset:"bd-inep-censo-escolar",name:"INEP / Base dos Dados — Censo Escolar tratado",type:"Base nacional tratada",status:"planejada",detail:"Tabelas tratadas e harmonizadas da Base dos Dados, com cobertura de 2007–2025 no catálogo consultado; conferir metadados de cada tabela e mudanças de divulgação/privacidade antes de consulta."},{id:"edu-bd-catalogo",dataset:"bd-inep-catalogo-escolas",name:"INEP / Base dos Dados — Catálogo de Escolas",type:"Catálogo nacional de escolas",status:"planejada",detail:"Consulta e exportação de endereço e oferta educacional por município, rede e outros filtros; a página não informa a edição temporal. Validar ano, filtros e campos exportados; não registrar como base extraída."},{id:"edu-setores",dataset:"ibge-setores-2022",name:"IBGE — Malha de Setores Censitários 2022",type:"Base territorial complementar",status:"planejada",detail:"Geometria definitiva dos setores para territorialização e junções espaciais."},{id:"edu-agregados",dataset:"ibge-agregados-setores-2022",name:"IBGE — Agregados por Setores Censitários 2022",type:"Base territorial complementar",status:"planejada",detail:"Indicadores do universo por setor para contextualizar território e desigualdades; preservar versão/data dos arquivos."}
  ]
 },
 "laudemio":{
  updated:"2026-09-25",
  ...
  stages:[
   ...
   {id:"transacoes",label:"Laudêmio, transmissões e dinheiro",status:"em_apuracao",evidence:["Escopo busca localizar prédios/apartamentos e relações de cobrança em escala, não apenas casos isolados","Cadastro imobiliário, ITIV e consulta de VVA podem complementar matrículas com identificadores e valores administrativos; acesso em massa ainda precisa ser testado"],sources:["lau-matriculas","lau-vva"]},
  ...
  sources:[
   ...
   {id:"lau-apeb",dataset:"apeb-aforamentos-codices",name:"APEB — códices de aforamentos",type:"Fonte arquivística",status:"usada",detail:"Referências registradas: Códice 158, fls. 11 e 24; Códice 165, f. 64; Códice 347 com páginas ainda a identificar."},{id:"lau-vva",dataset:"salvador-vva",name:"SEFAZ Salvador — Valor Venal Atualizado",type:"Fonte pública complementar",status:"planejada",detail:"Consulta individual por inscrição imobiliária para valor administrativo do imóvel; testar utilidade e acesso em escala antes de incorporar à base própria."}
  ]
 }
};
