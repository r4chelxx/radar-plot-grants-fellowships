...
window.RADAR_PARTS.investigations={
 ...
 "data-centers":{
  ...
  stages:[
   ...
   {id:"energia",label:"Energia, conexão e transmissão",status:"em_apuracao",evidence:["Atos regulatórios e infraestrutura elétrica já integram a apuração","Divergência documental de extensão de conexão do SRNA Chuí permanece registrada"],sources:["dc-aneel-atos","dc-delano"]},
